...
Route::prefix('admin')->namespace('Admin')->middleware('auth')->group(function(){
    ...
    Route::any('users/{id}/roles/create', 'ACL\RoleUserController@usersAvailable')->name('users.roles.available');
     ...
     */
    Route::get('roles/{id}/permission/{idPermission}/detach', 'ACL\PermissionProfileController@detachPermissionRole')->name('roles.permission.detach');
     ...
     * Routes Tenants
     */
    Route::any('tenants/search', 'TenantController@search')->name('tenants.search')->middleware('can:tenants');
    Route::resource('tenants', 'TenantController')->middleware('can:tenants');

    /**
     * Routes Tables
     */
    Route::any('tables/qrcode/{identify}', 'TableController@qrcode')->name('tables.qrcode')->middleware('can:tables');
    Route::any('tables/search', 'TableController@search')->name('tables.search')->middleware('can:tables');
     ...
     * Routes Categories
     */
    Route::any('categories/search', 'CategoryController@search')->name('categories.search')->middleware('can:categories');
    Route::resource('categories', 'CategoryController')->middleware('can:categories');
    
    /**
     * Routes Users
     */
    Route::any('users/search', 'UserController@search')->name('users.search')->middleware('can:users');
